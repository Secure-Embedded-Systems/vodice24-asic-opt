// POLY1305 design based on: https://www.oryx-embedded.com/doc/poly1305_8c.html
...
void poly1305ProcessBlock(Poly1305Context *context) {
  ...
  if (0) {
    printf("PROCESSBLOCK A[0] %x\n", a[0]);
    printf("PROCESSBLOCK A[1] %x\n", a[1]);
    printf("PROCESSBLOCK A[2] %x\n", a[2]);
    printf("PROCESSBLOCK A[3] %x\n", a[3]);
    printf("PROCESSBLOCK A[4] %x\n", a[4]);
  }
